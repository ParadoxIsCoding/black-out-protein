  ...
  return (
    <section id="story" style={{ padding: '8rem 0', backgroundColor: 'var(--bg-color-light)', borderTop: '1px solid var(--border-color)', borderBottom: '1px solid var(--border-color)' }}>
      <div className="container flex flex-col items-center">
        <div style={{ backgroundColor: '#161616', borderRadius: '16px', border: '1px solid #222', padding: '4rem', maxWidth: '900px', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <div style={{ fontSize: '1.15rem', color: 'var(--text-muted)', lineHeight: '1.8', fontWeight: 600, textAlign: 'center' }}>
            ...
            <p style={{ marginBottom: '1.5rem' }}>
              With the connections of my pharmaceutical veteran dad I was able to work with nutritionalists and scientists to develop a product that has 26g protein, 4g creatine and flavour specific ingredients. The formula has come to be known as <strong className="text-white">BLACKD OUT PROTEIN</strong> and people love it.
            </p>
            <p>
